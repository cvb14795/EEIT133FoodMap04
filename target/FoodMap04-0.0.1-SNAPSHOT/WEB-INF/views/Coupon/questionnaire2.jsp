...
<body>
	...
	<form:form method='POST' modelAttribute='qBean' action='qcontroller' onsubmit="return chk();">
        <fieldset>
...
<form:form method='POST' modelAttribute="user" action="qcontroller">
	<input value="${isAdmin}" />
	<input path="userName" value="${name}" />
</form:form>
...
<!-- 				<p> -->
<!-- 					身分證字號: <label><input type='text' name='id' -->
...
<!-- 				<p> -->
<!-- 					聯絡電話: <label><input type='text' name='phone' required></label> -->
<!-- 				</p> -->
