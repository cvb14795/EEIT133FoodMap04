...
<head>
    ...
    <link rel="apple-touch-icon" href="http://i.imgur.com/QRAUqs9.png">
    <link rel="shortcut icon" href="http://i.imgur.com/QRAUqs9.png">
                                            ...
                                            <tbody>
                                                <c:forEach items="${members}" var="m">
	                                                <tr>
	                                                    <td class="avatar">
	                                                        <div class="round-img">
<%-- 																	<a href="#"><img class="rounded-circle" src="data:image/jpg;base64,${imageMap.get(m.account)}" ></a> --%>
																	<a href="#"><img class="rounded-circle" src="<c:url value='/Member/user/${m.account}/photo'/>" ></a>
	                                                        </div>
	                                                    </td>
	                                                    <td><span class="name">${m.name}</span></td>
	                                                    <td><span>${m.account}</span></td>
	                                                    <td><span>${m.idNum}</span></td>
...
<!-- 	                                                    </td> -->
    ...
    <script src="./js/admin/js/init/weather-init.js"></script>
