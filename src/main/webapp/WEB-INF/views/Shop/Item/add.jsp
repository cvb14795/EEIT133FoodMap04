		...
		<form id="form">	
			<fieldset>
				...
				<div class="st1">
					...
					<input class="formElem" type="text" name="name" required>
				</div>
				<div class="st1">
					<label for="" class="t1">商品描述:</label>
					<textarea class="formElem" rows="5" cols="33" name="description" placeholder="請輸入商品描述(產品特色、尺寸規格...)" required></textarea>
				</div>
				<div class="st1">
