...
<body>
	...
	<jsp:useBean id="recipe" class="cf.cvb14795.recipe.model.RecipeBean" scope="session"></jsp:useBean>
    <form action="./AdminEditRecipeServlet" method="post">
        <fieldset>
            <legend>官方食譜</legend>
            <div class="st1">
            ...
            <div class="st1">
                ...
                <img src="data:image/jpg;base64,${imgList.get(param.index)}" width="100" height="100" >
