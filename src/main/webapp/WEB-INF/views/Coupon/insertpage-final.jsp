		...
		<form:form method='POST' modelAttribute="couponBean" action='coupons'>
			<fieldset class="fieldset-auto-width">
				...
				<table>
					...
					<tr>
						<td align='right'>生效時間<font size='-3' color='blue'></font>：<br>&nbsp;
						</td>
					...
					<tr>
						...
						<td><form:input path="value"  size="50" id="value" /><br>&nbsp;
					...
					<tr>
						...
						<td><form:input path="description" size="50" id="description"/><br>&nbsp;
					...
					<tr>
						...
						<input type="button" style="font-weight:bold;" name="submit" value="一鍵" id="btn">
						
						<input type='submit' style="font-weight:bold;"  value='提交'></td>
					</tr>
				</table>
			</fieldset>
		</form:form>
