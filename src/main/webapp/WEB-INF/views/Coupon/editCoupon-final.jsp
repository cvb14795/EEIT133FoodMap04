...
<script type="text/javascript">
	...
	function confirmDelete(id){
		...
		if (result) {
			document.getElementById("bean").putOrDelete.name = "_method";
			document.getElementById("bean").putOrDelete.value = "DELETE";
			document.getElementById("bean").action = "<c:url value='/Coupon/coupons/" + id + "' />";
		    return true;
		}
		return false;
	}
	...
	function confirmUpdate(id){
		...
		if (result) {
			document.getElementById("bean").putOrDelete.name = "_method";
			document.getElementById("bean").putOrDelete.value = "PUT";
			document.getElementById("bean").action = "<c:url value='/Coupon/coupons/" + id + "' />";
		    return true;
		}
		return false;
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href=<c:url value='/Coupon/adminforCoupon'/>> <i class="menu-icon ti-email"></i>防疫專區 </a>
                    </li>
                    <li>
		...
		<form:form method='POST' modelAttribute="bean">
			...
			<fieldset class="fieldset-auto-width">
				...
				<table>
					...
					<tr>
						<td align='right'>失效時間<font size='-3' color='blue'></font>：<br>&nbsp;
						</td>
					...
					<tr>
						<td align='right'>內容：<br>&nbsp;</td>
						<td><form:input path="value"  size="50" /><br>&nbsp;
					...
					<tr>
						<td align='right'>為折數折價券(1:是, 0:否)：<br>&nbsp;</td>
					...
					<tr>
						<td align='right'>為扣減折價券(1:是, 0:否)：<br>&nbsp;</td>
					...
					<tr>
						...
						<td><form:input path="description" size="50" /><br>&nbsp;
