...
<!-- 	</div> -->
	...
	<div class="container">
		<div align='center' style="height:500px; width:500;padding:100px;">
			<div style="margin-bottom:50px;"><h1 style="font-weight:bold;">折價券管理</h1></div>
			<br>
			<h4 style="font-weight:bold;"><a href='insertCoupon'>新增折價券資料</a></h4><br>
			<h4 style="font-weight:bold;"><a href='showCoupons'>顯示折價券資料</a></h4><br> 
			<hr>
			<h4 style="margin:10px;font-size:20px;font-weight:bold;"><a onclick="location.href='<c:url value='/' />'">首頁</a></h4><br>
		</div>
	</div>
