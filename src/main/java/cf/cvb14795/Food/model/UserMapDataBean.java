...
@Entity
@Table(name = "userMapData")
public class UserMapDataBean implements Serializable {
	...
	public UserMapDataBean() {
	}
	
	public UserMapDataBean(String mapname, String mapku, String mapnb, String mapxy, String mapcheck, String category
