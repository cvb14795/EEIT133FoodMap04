        ...
        <form action="./Revise" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="st1">
                    ...
                    <input type="text" name="name" id="name" class="formElem" value="${sessionScope.member.name}">
                ...
                <div class="st1">
                    ...
                    <input type="text" name="ID" id="ID" class="formElem" value="${sessionScope.member.ID}">
                    <label for="ID" id="IDCheckMsg" class="validation"></label><br>
                </div>
                <div class="st1">
                    <label for="account" class="t1">帳號：</label>
                    <input type="text" name="account" id="account" class="formElem" value="${sessionScope.member.account}" disabled>
                ...
                <div class="st1">
                    ...
                    <input type="text" name="email" id="email" class="formElem" value="${sessionScope.member.email}">
                    <label for="email" id="emailCheckMsg" class="validation"></label><br>
                </div>
                <div class="st1">
                    <label for="address" class="t1">地址：</label>
                    <input type="text" name="address" id="address" class="formElem" value="${sessionScope.member.address}">
                    <label for="address" id="addressCheckMsg" class="validation"></label><br>
                </div>
                <div class="st1">
                    <label for="phone" class="t1">電話：</label>
                    <input type="text" name="phone" id="phone" class="formElem" maxlength="10" value="${sessionScope.member.phone}">
                ...
                <div class="st1">
                    ...
                    <img src="data:image/${sessionScope.imgExt};base64,${sessionScope.base64String}">
                </div>
                <div class="st1">
